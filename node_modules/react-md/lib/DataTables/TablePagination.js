(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'classnames', '../utils/getField', '../SelectFields/SelectField', '../Buttons/Button'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('classnames'), require('../utils/getField'), require('../SelectFields/SelectField'), require('../Buttons/Button'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.classnames, global.getField, global.SelectField, global.Button);
    global.TablePagination = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _classnames, _getField, _SelectField, _Button) {
  'use strict';
  ...
  TablePagination = function (_PureComponent) {
    ...
    _createClass(TablePagination, [{
      ...
      value: function _increment() {
        ...
        var nextPage = typeof page !== 'undefined' ? page + 1 : newStart / rowsPerPage + 1;
      ...
      value: function render() {
        var controlsMarginLeft = this.state.controlsMarginLeft;
        ...
        var _props2 = this.props,
            ...
            page = _props2.page,
            props = _objectWithoutProperties(_props2, ['className', 'rows', 'rowsPerPageLabel', 'rowsPerPageItems', 'incrementIconChildren', 'incrementIconClassName', 'decrementIconChildren', 'decrementIconClassName', 'page']);
