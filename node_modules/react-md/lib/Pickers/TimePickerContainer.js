    ...
    _createClass(TimePickerContainer, [{
      ...
      value: function render() {
        ...
        var _props3 = this.props,
            ...
            props = _objectWithoutProperties(_props3, ['id', 'disabled', 'label', 'placeholder', 'icon', 'inline', 'displayMode', 'style', 'className', 'pickerStyle', 'pickerClassName', 'fullWidth', 'lineDirection', 'aria-label']);
