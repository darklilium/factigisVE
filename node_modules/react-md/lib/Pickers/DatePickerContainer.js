(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'classnames', 'react-prop-types/lib/isRequiredForA11y', 'react-prop-types/lib/deprecated', '../constants/keyCodes', '../utils/getField', '../utils/PropTypes/controlled', '../utils/DateUtils/isDateEqual', '../utils/DateUtils/addDate', '../utils/DateUtils/DateTimeFormat', '../Helpers/Collapse', '../FontIcons/FontIcon', '../TextFields/TextField', '../Dialogs/DialogContainer', './DatePicker'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('classnames'), require('react-prop-types/lib/isRequiredForA11y'), require('react-prop-types/lib/deprecated'), require('../constants/keyCodes'), require('../utils/getField'), require('../utils/PropTypes/controlled'), require('../utils/DateUtils/isDateEqual'), require('../utils/DateUtils/addDate'), require('../utils/DateUtils/DateTimeFormat'), require('../Helpers/Collapse'), require('../FontIcons/FontIcon'), require('../TextFields/TextField'), require('../Dialogs/DialogContainer'), require('./DatePicker'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.classnames, global.isRequiredForA11y, global.deprecated, global.keyCodes, global.getField, global.controlled, global.isDateEqual, global.addDate, global.DateTimeFormat, global.Collapse, global.FontIcon, global.TextField, global.DialogContainer, global.DatePicker);
    global.DatePickerContainer = mod.exports;
  }
})(this, function (exports, _react, _classnames, _isRequiredForA11y, _deprecated, _keyCodes, _getField, _controlled, _isDateEqual, _addDate, _DateTimeFormat, _Collapse, _FontIcon, _TextField, _DialogContainer, _DatePicker) {
  'use strict';
  ...
  var DatePickerContainer = function (_PureComponent) {
    ...
    function DatePickerContainer(props) {
      ...
      if (typeof initialCalendarDate !== 'undefined' && !props.value && !props.defaultValue) {
        calendarTempDate = typeof initialCalendarDate === 'string' ? new Date(initialCalendarDate) : initialCalendarDate;
    ...
    _createClass(DatePickerContainer, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (!(0, _isDateEqual2.default)(minDate, nextProps.minDate) || !(0, _isDateEqual2.default)(maxDate, nextProps.maxDate)) {
          var date = this._validateDateRange(this.state.calendarDate, nextProps.minDate, nextProps.maxDate);
          if (date) {
      ...
      value: function render() {
        var _props6 = this.props,
            ...
            pickerStyle = _props6.pickerStyle,
            pickerClassName = _props6.pickerClassName,
            label = _props6.label,
            ...
            lineDirection = _props6.lineDirection,
            id = _props6.id,
            disabled = _props6.disabled,
            ariaLabel = _props6['aria-label'],
            isOpen = _props6.isOpen,
            props = _objectWithoutProperties(_props6, ['style', 'className', 'pickerStyle', 'pickerClassName', 'label', 'placeholder', 'icon', 'inline', 'displayMode', 'fullWidth', 'lineDirection', 'id', 'disabled', 'aria-label', 'isOpen']);
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_TextField2.default, {
            ...
            leftIcon: icon,
            disabled: disabled,
            className: (0, _classnames2.default)({ 'md-pointer--hover': !disabled }),
            inputClassName: (0, _classnames2.default)({ 'md-pointer--hover': !disabled }),
  ...
  DatePickerContainer.propTypes = {
     ...
     * today.
     */
    initialCalendarDate: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.instanceOf(Date)]),
     ...
     */
    defaultCalendarMode: _react.PropTypes.oneOf(['calendar', 'year']),
    ...
    maxDate: function maxDate(props, propName, component) {
      ...
      var err = _react.PropTypes.instanceOf(Date).apply(undefined, [props, propName, component].concat(others));
     ...
     */
    yearsDisplayed: _react.PropTypes.number,
     ...
     */
    formatOptions: _react.PropTypes.shape({
      weekday: _react.PropTypes.oneOf(['narrow', 'short', 'long']),
      era: _react.PropTypes.oneOf(['narrow', 'short', 'long']),
      year: _react.PropTypes.oneOf(['numeric', '2-digit']),
      month: _react.PropTypes.oneOf(['numeric', '2-digit', 'narrow', 'short', 'long']),
      day: _react.PropTypes.oneOf(['numeric', '2-digit']),
      hour: _react.PropTypes.oneOf(['numeric', '2-digit']),
      minute: _react.PropTypes.oneOf(['numeric', '2-digit']),
      second: _react.PropTypes.oneOf(['numeric', '2-digit']),
      timeZoneName: _react.PropTypes.oneOf(['short', 'long'])
    }),
    ...
    previousIcon: (0, _deprecated2.default)(_react.PropTypes.node, 'Use `previousIconChildren` and `previousIconClassName` instead'),
    nextIcon: (0, _deprecated2.default)(_react.PropTypes.node, 'Use `nextIconChildren` and `nextIconClassName` instead'),
    adjustMinWidth: (0, _deprecated2.default)(_react.PropTypes.bool, 'No longer valid for a text field'),
    ...
    initialCalendarMode: (0, _deprecated2.default)(_react.PropTypes.oneOf(['calendar', 'year']), 'Use `defaultCalendarMode` instead'),
    initialYearsDisplayed: (0, _deprecated2.default)(_react.PropTypes.number, 'Use `yearsDisplayed` instead. I have not implemented infinite loading years')
  };
