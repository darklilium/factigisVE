(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'react-addons-css-transition-group', 'react-prop-types/lib/deprecated', '../constants/CSSTransitionGroupTick', './isInvalidAnimate', '../Helpers/Portal', './Snackbar'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('react-addons-css-transition-group'), require('react-prop-types/lib/deprecated'), require('../constants/CSSTransitionGroupTick'), require('./isInvalidAnimate'), require('../Helpers/Portal'), require('./Snackbar'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.reactAddonsCssTransitionGroup, global.deprecated, global.CSSTransitionGroupTick, global.isInvalidAnimate, global.Portal, global.Snackbar);
    global.SnackbarContainer = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _reactAddonsCssTransitionGroup, _deprecated, _CSSTransitionGroupTick, _isInvalidAnimate, _Portal, _Snackbar) {
  'use strict';
    ...
    _createClass(SnackbarContainer, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['transitionName', 'transitionEnterTimeout', 'transitionLeaveTimeout', 'dismiss', 'onDismiss', 'renderNode']);
  ...
  SnackbarContainer.propTypes = {
     ...
     * should be displayed.
     */
    autohideTimeout: _react.PropTypes.number.isRequired,
    ...
    dismiss: (0, _deprecated2.default)(_react.PropTypes.func, 'Use `onDismiss` instead')
  };
