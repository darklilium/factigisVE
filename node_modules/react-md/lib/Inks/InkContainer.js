(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'react-addons-transition-group', 'classnames', '../utils/EventUtils/isValidClick', '../utils/EventUtils/captureNextEvent', '../utils/calcPageOffset', '../utils/NumberUtils/calculateHypotenuse', './Ink'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('react-addons-transition-group'), require('classnames'), require('../utils/EventUtils/isValidClick'), require('../utils/EventUtils/captureNextEvent'), require('../utils/calcPageOffset'), require('../utils/NumberUtils/calculateHypotenuse'), require('./Ink'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.reactAddonsTransitionGroup, global.classnames, global.isValidClick, global.captureNextEvent, global.calcPageOffset, global.calculateHypotenuse, global.Ink);
    global.InkContainer = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _reactAddonsTransitionGroup, _classnames, _isValidClick, _captureNextEvent, _calcPageOffset, _calculateHypotenuse, _Ink) {
  'use strict';
