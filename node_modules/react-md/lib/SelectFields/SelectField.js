(function (global, factory) {
  ...
  var SelectField = function (_PureComponent) {
    ...
    _createClass(SelectField, [{
      ...
      value: function componentWillUpdate(nextProps, nextState) {
        ...
        if (this._field && (0, _getField2.default)(this.props, this.state, 'isOpen') !== isOpen) {
          this._field.focus();
        }
      }
    }, {
      ...
      value: function _handleKeyDown(e) {
        ...
        if (!isOpen && (key === _keyCodes.DOWN || key === _keyCodes.UP)) {
          this._handleOpen(e);
          return;
      ...
      value: function _advanceFocus(decrement) {
        ...
        var below = position === SelectField.Positions.BELOW;
        var lastIndex = menuItems.length - 1;
      ...
      value: function render() {
        ...
        var _props6 = this.props,
            ...
            props = _objectWithoutProperties(_props6, ['id', 'style', 'className', 'listStyle', 'listClassName', 'inputStyle', 'inputClassName', 'disabled', 'menuItems', 'position', 'stretchList', 'errorText', 'helpText', 'helpOnFocus', 'required']);
  ...
  SelectField.propTypes = {
    ...
    fullWidth: (0, _deprecated2.default)(_react.PropTypes.bool, 'No longer valid to use since select fields are no longer text fields'),
